...
from b2.console_tool import (
    AuthorizeAccount, CancelAllUnfinishedLargeFiles, CancelLargeFile, ClearAccount, CopyFileById,
    CreateBucket, DeleteBucket, DeleteFileVersion, DeleteKey, DownloadFileById, DownloadFileByName,
    GetBucket, GetDownloadAuth, GetDownloadUrlWithAuth, HideFile, ListBuckets, ListKeys, ListParts,
    ListUnfinishedLargeFiles, Ls, Rm, MakeUrl, Sync, UpdateBucket, UploadFile, UpdateFileLegalHold,
    UpdateFileRetention, ReplicationSetup, ReplicationDelete, ReplicationPause, ReplicationUnpause,
    ReplicationStatus, License, InstallAutocomplete, CreateKey, GetAccountInfo, B2
)
